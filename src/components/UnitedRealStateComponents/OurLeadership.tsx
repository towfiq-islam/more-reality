      ...
      <div className="grid grid-cols-12 gap-10 items-center relative px-20">
        ...
        <div className="col-span-7">
          <h3
            data-aos="fade-up"
            data-aos-delay="100"
            className="text-3xl font-semibold text-primary-text-blue mb-3"
          >
            John Wick
          </h3>
          <p
            data-aos="fade-up"
            data-aos-delay="100"
            className="text-secondary-text text-xl mb-10"
          >
          ...
          <p
            data-aos="fade-up"
            data-aos-delay="100"
            className="text-2xl text-primary-text-blue leading-[150%]"
          >
        ...
        <p
          data-aos="fade-up"
          data-aos-delay="100"
          className="text-[220px] text-primary-blue absolute -top-22 left-0 "
        >
          “
        </p>
        <p
          data-aos="fade-up"
          data-aos-delay="100"
          className="text-[220px] text-primary-blue absolute -bottom-44 right-0 "
        >
          ”
        </p>
      </div>
