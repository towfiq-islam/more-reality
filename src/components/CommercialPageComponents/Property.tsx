import { FamilySvg, IndustrySvg, LandSvg, OfferSvg, PropertySvg, SpecialSvg } from "../SvgContainer/SvgContainer";
                ...
                <div className="grid grid-cols-3 gap-20">
                    {
                        data?.map(item => <div key={item?.id}>
                            <span>{item?.icon}</span>
                            <h3 className="text-primary-text-blue uppercase font-semibold text-xl mt-3 mb-2">{item?.title}</h3>
